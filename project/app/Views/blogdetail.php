                ...
                <div class="row py-3 my-4" >
                         <div class="col-md-12">
                            <div class="card mb-3 card-bg" style="max-width: 540px;">
                                <div class="row g-0">
                                  <div class="col-md-4">
                                    <img src="<?php echo base_url();?>/assets/img/blogwriter.png" class="img-fluid" alt="...">
                                  </div>
                                  <div class="col-md-8">
                                    <div class="card-body">
                                      <h5 class="card-title"><span style="vertical-align: -130px;">
                                      <?php echo $blogdetail->blog_createdby; ?></span></h5>
                                      
                                      <p class="card-text"><small class="card-text-muted">Ventura Technology | <?php $pudate = $blogdetail->blog_createon; ?><?php echo date("M d,Y", strtotime($pudate) );?></small></p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            <div>
                                <h1><?php echo $blogdetail->blog_title; ?></h1>
