...
<body>
    ...
    <main class="vt-main">
            ...
            <div class="banner-content">
                <div class="left-side">
                    <div class="content">
                        ...
                        <p>Your success lies in creating a learning culture that fosters productivity, performance and profit in your organization.</p>
                    </div>
                </div>
                <div class="center">
                ...
                <div class="right-side">
                    <div class="content">
                        ...
                        <p>our goal is to empower you with the right strategy, technology and measurability, and craft learning experiences that help you meet succeed</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>            
            <div><img src="<?php echo base_url();?>/assets/img/HomePage-07.png" alt="" class="vt-home-image2" ></div>                
        </section>
        ...
        <section>            
            <div class="vt-ban-img">
                ...
                <div class="container">
                    <div class="row justify-content-center vt-headding-h2">
                        <div class="col-8">
                            <h2>we understand this</h2>
                            <p>With our 90+ year of collective team experience and expertise of working with latest technologies and trands, we deliver the most appropriate and impactful solution-specific to your goals.</p>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        ...
                        <img src="<?php echo base_url();?>/assets/img/1.png" class="vt-our-image" alt=""/></div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="vt-our-border">
                        <img src="<?php echo base_url();?>/assets/img/2.png" class="vt-our-image" alt=""/></div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="vt-our-border">
                        <img src="<?php echo base_url();?>/assets/img/3.png" class="vt-our-image" alt=""/></div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="vt-our-border">
                        <img src="<?php echo base_url();?>/assets/img/4.png" class="vt-our-image" alt=""/></div>
                    </div>
                  </div>
            </div>
        </section>
                    ...
                    <div class="col">
                      ...
                      <div class="col-8">
                        <div class="vt-span   text-center">
                            <p>
                            We curate content that is best suited for your learners-that talks their language, matches their proficiency and connects with their minds.
                        </p></div>
                      </div>
                      <div class="col">
        ...
        <div class="container" style="width: 80%;">
            <div class="row">
                <div class="col-md-4" style="position: relative;">
                    ...
                    <div class="centered">210+</div>
                    <p class="text-center vt-p-18">Learning Hours</p>
                </div>
                <div class="col-md-4" style="position: relative;"><img src="<?php echo base_url();?>/assets/img/HomePage_4-23.png" alt="" class="img-fluid"/>
                <div class="centered">75+</div>
                    <p class="text-center vt-p-18">Happy Customers</p>
                </div>
                <div class="col-md-4" style="position: relative;"><img src="<?php echo base_url();?>/assets/img/HomePage_4-24.png" alt="" class="img-fluid"/>
                <div class="centered">102+</div>
                    <p class="text-center vt-p-18">Appreciations and Recognitions</p>
                </div>
            </div>
        </div>
            <div class="container" style="width: 80%;position: relative;">
                <div class="row" >
                    <div class="">
                        <div id="owl-demo2" class="owl-carousel owl-theme">	
                        
                            <div class="item">
                                <div class="col"><div class="shedow">
                                    <div class="card shadow-sm" style="height: 670px;">
                                        <div class="text-center"><br>
                                        <img class="rounded-circle shadow-1-strong mb-4"
                                     src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(32).webp" alt="avatar"
                                     style="width: 150px;" />
                                     <p>Zenobia Sethna<br><small>VP & Head of eLarning Imarticus Learning</small></p>
                                    </div>
                                      <div class="card-body">
                                        <p class="card-text">We've been working with Ventura Technologies for more than 2 years. With each new project, we've been impressed with their creatives efforts. We also rely on their professional project management Overall, Ventura provides Tyco with a good product at a good value. We are happy to be working with them.</p>
                            ...
                            <div class="item">
                             <div class="col"><div class="shedow">
                                <div class="card shadow-sm" style="height: 670px;">
                                  ...
                                  <div class="card-body">
                                    <p class="card-text">We are extremely impressed with Ventura Technologies instructional designing approach, the quality of the graphics and the project management process. The overall experience of working with them has been impressive.</p>
                            ...
                            <div class="item">
                             <div class="col"><div class="shedow">
                                <div class="card shadow-sm" style="height: 670px;">
                                  ...
                                  <div class="card-body">
                                    <p class="card-text">It was a total pleasure working with Ventura Technologies based in Pune. We found the project team who worked with us excellent, they worked with us as they are in our office, we did not feel the distance. The team is truly professional<br>
          The astounded aspect was at the quality of the work, the level of contact, the value for money, the genuineness of Aparna and her team in understanding the instructional methodology and bringing an efficient Content with great engagement capabilities.</p>
                            ...
                            <div class="item">
                             <div class="col"><div class="shedow">
                                <div class="card shadow-sm" style="height: 670px;">
                                  ...
                                  <div class="card-body">
                                    <p class="card-text">I was really impressed with the high level of customer service by the Ventura team. The courseware developed is so much in match with the best in breed offerings - there is no doubt that they see your business in terms of building a relationship, rather than managing a transaction. <br> I have already recommended Ventura Technologies to all my clients and will be starting to work on our next projects shortly.</p>
                        ...
                        <a class="btn owlprev"><i class="fa fa-chevron-left" ></i></a>
                        <a class="btn owlnext"><i class="fa fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
       ...
       <section class="vt-pink-color">
        <div class="container text-center">
            <div class="row">
              <div class="col">
                <p class="pk"><span class="spanpk">Collaborate</span> to create a measurable impact through<span class="spanpk">learning</span></p>
                <div class="wrapper1">
                    <a class="cta" href="#">
                      <span>Connect Now</span>
                      <span>
                        <svg width="30px" height="25px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
