...
?>
    ...
    <div class="card card-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" action="<?php echo base_url('admin/add-accessform-process') ?>" enctype="multipart/form-data" method="post" id="quickForm">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="inputName" name="formname" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputSlug" class="col-sm-2 col-form-label">Url</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="inputSlug" name="url" >
                    </div>
                  </div>  
