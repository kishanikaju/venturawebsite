...
?>
    ...
    <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="<?php echo base_url('admin/blog-category-add') ?>" enctype="multipart/form-data" method="post" id="quickForm">
                <div class="card-body">
...
$("#slug").val(name);
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control" id="inputMetaTitle" name="metatitle" placeholder="Meta Title" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputMetaDescription" class="col-sm-2 col-form-label">Meta Description</label>
                    <div class="col-sm-6">
                    <textarea id="inputMetaDescription" name="metadescription" class="form-control"  rows="5" required></textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                    <textarea id="inputMetaKeywords" name="metakeywords" class="form-control"  rows="5" required></textarea>
