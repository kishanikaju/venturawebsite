...
?>
    ...
    <div class="card card-info">
              ...
              <form class="form-horizontal" action="<?php echo base_url('admin/cms-update/'.$cms_page['cms_id']) ?>" enctype="multipart/form-data" method="post" id="quickForm">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control" id="name" name="name" value="<?php echo $cms_page['name']?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control" id="slug" name="slug" placeholder="Slug" value="<?php echo $cms_page['slug']?>">
                  ...
                  <div class="form-group row">
                    ...
                    <textarea class="form-control" id="editor" name="content" ><?php echo $cms_page['cms_content']?></textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <textarea id="inputHeadscript" name="headscript" class="form-control"  rows="5"><?php echo $cms_page['header_script']?></textarea>
                  ...
                  <div class="form-group row">
                        ...
                        <div class="offset-sm-2 col-sm-10">
                            ...
                            <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" name="status" id="exampleCheck3" value="Y" <?php echo $cms_page['status']=="Y" ? "checked" : ""?>>
                  ...
                  <?php  
                    ...
                    <div class="col-sm-3"> Date:                     
                      ...
                      <input type="date" class="form-control" id="date" name="publishdate" value="<?php echo $items[0]; ?>">

                      Time:<input type="time" class="form-control" id="time" name="publishtime"  value="<?php echo $items[1]; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control" id="inputMetaTitle" name="metatitle" value="<?php echo $cms_page['meta_title']?>">
                  ...
                  <div class="form-group row">
                    ...
                    <textarea id="inputMetaDescription" name="metadescription" class="form-control"  rows="5"><?php echo $cms_page['meta_des']?></textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <textarea id="inputMetaKeywords" name="metakeywords" class="form-control"  rows="5"><?php echo $cms_page['meta_keyword']?></textarea>
